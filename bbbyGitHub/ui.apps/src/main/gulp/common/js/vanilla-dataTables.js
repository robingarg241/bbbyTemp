 ...
 * Version: 1.6.11
 *
 * P.S. : this aint vanilla no more. Added some code to support sorting of date format in MMMM D, YYYY
 */
...
})(typeof global !== 'undefined' ? global : window || global, function (plugin) {
    "use strict";
    var win = window,
        doc = document,
        body = doc.body;
    ...
    var parseDate = function (content, format) {
        ...
        if (format) {
            switch (format) {
                ...
                case "MMMM D, YYYY":
                    date = moment(content, 'MMMM D, YYYY').format("YYYYMMDD");
                    break;
                default:
