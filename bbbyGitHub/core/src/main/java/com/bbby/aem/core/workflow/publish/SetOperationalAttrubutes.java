 ...
 *
 */
@Component(service = WorkflowProcess.class, property = { "process.label=Publish Set Operational Attributes",
		"Constants.SERVICE_VENDOR=BBBY",
		"Constants.SERVICE_DESCRIPTION=BBBY APPROVE AND PUBLISH, Set Operational Attributes" })
public class SetOperationalAttrubutes implements WorkflowProcess {
	...
	public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap)
		...
		log.info("entering execute of set operation attribute");
