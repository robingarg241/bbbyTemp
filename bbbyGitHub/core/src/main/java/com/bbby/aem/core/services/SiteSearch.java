 ...
 * <h2>HERO Comment</h2>
 *
 * This file is copied from /libs/foundation/src/impl/src/com/day/cq/wcm/foundation/Search.java
 *
 * <h2>Adobe Comment</h2>
 *
 * The <code>Search</code> class implements the search logic used in the foundation search component and exposes the
 * query result in a scripting friendly object structure.
 * <p/>
 * This class does a fulltext query, which means wildcards like '*' and '?' will be filtered out. Please use
 * {@link QueryBuilder} or execute a query directly on the JCR Session if wildcard support is needed.
 */
public final class SiteSearch {
     ...
     */
    public SiteSearch(SlingHttpServletRequest request) {
        this.request = request;
        this.resource = request.getResource();
        this.search = resource.adaptTo(SimpleSearch.class);

        if (search == null) throw new IllegalStateException("Could not resolve SimpleSearch for " + resource);
        ...
        // START HERO CUSTOMIZATION
        Predicate excludes = new Predicate("hideInAemSearch", "property");
        excludes.set("property", JcrConstants.JCR_CONTENT + "/hideInAemSearch");
        excludes.set("operation", "exists");
        excludes.set("value", "false");
        this.search.addPredicate(excludes);
    ...
    /**
     * @return the query result or <code>null</code> if there is neither a query parameter set nor a tag predicate.
     * @throws RepositoryException if an exception occurs while executing the query.
     */
    ...
    /**
     * @return the query supplied by the user or an empty String if none is provided.
     */
    ...
    public void setQuery(String query) {
        // START HERO
        // It has been observed that the search query '+ ' is extremely slow and leads an unresponsive AEM instance.
        // Removing all logical operators from the query in order to avoid any performance issues.
        if (query != null) {
            query = query.trim();

            // for dashes, preserve dashes inside a word, but remove any dashes with preceding or trailing space, or
            // that start or end the query
            query = StringUtils.replace(query, " -", " ");
            query = StringUtils.replace(query, "- ", " ");
            query = StringUtils.replacePattern(query, "-$", "");
            query = StringUtils.replacePattern(query, "^-", "");
            ...
            query = StringUtils.replace(query, " OR ", " ");
     ...
     *
     * @deprecated since 5.2. Excerpt properties can now only be specified in the <a href=
     *             "http://localhost:4502/system/console/configMgr/com.day.cq.search.impl.builder.QueryBuilderImpl"
     *             >configuration of the QueryBuilder interface</a>. For 5.3, when Jackrabbit 1.5 is used, the excerpt
     *             properties can be configured in the repository.
     *
     */
    @Deprecated
    ...
    /**
     * @param properties comma separated names of the properties that will be used in an excerpt.
     *
     * @deprecated since 5.2. Excerpt properties can now only be specified in the <a href=
     *             "http://localhost:4502/system/console/configMgr/com.day.cq.search.impl.builder.QueryBuilderImpl"
     *             >configuration of the QueryBuilder interface</a>. For 5.3, when Jackrabbit 1.5 is used, the excerpt
    ...
    public final class Result {
        ...
        /**
         * @return a List of {@link Page}es to display the navigation through the result pages.
         * @throws RepositoryException if an error occurs while reading from the query result.
         */
        ...
        /**
         * @return the page, which contains the information about the previous page. Returns <code>null</code> if there
         *         is no previous page (i.e. the current page is the first page).
         * @throws RepositoryException if an error occurs while reading from the query result.
         */
        ...
        /**
         * @return the page, which contains the information about the next page. Returns <code>null</code> if there is
         *         no next page (i.e. the current page is the last page).
         * @throws RepositoryException if an error occurs while reading from the query result.
         */
        ...
        public String getTrackerScript() {
            ...
            sb.append(encodeURL(search.getQuery().toLowerCase(Locale.US)));
         ...
         * @throws RepositoryException if an error occurs while executing the query or calculating the facets.
         */
    ...
    public final class Hit {
         ...
         * @throws RepositoryException if an error occurs while reading form the repository.
         */
         ...
         * @throws RepositoryException if an error occurs while building the excerpt.
         */
        ...
        /**
         * Returns <code>true</code> if the given node is either of type <code>cq:Page</code>,
         * <code>cq:PseudoPage</code>or <code>dam:Asset</code>.
         *
         * @param n the node to check.
         * @return <code>true</code> if the node represents either a page or an asset; <code>false</code> otherwise.
        ...
        /**
         * Returns <code>true</code> if the given node is either of type <code>cq:Page</code> or
         * <code>cq:PseudoPage</code>.
         *
         * @param n the node to check.
         * @return <code>true</code> if the node represents a page; <code>false</code> otherwise.
         * @throws RepositoryException if an error occurs during the check.
         */
    ...
    /**
     * Encodes the given <code>url</code> using {@link URLEncoder#encode(String, String)} with a <code>UTF-8</code>
     * encoding.
     *
    ...
    /**
     * Returns the icon path for the given extension or <code>null</code> if none is found for the given extension.
     *
