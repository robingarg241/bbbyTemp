 ...
 *
 */
@Component(service = WorkflowProcess.class, property = { "process.label=Nightly Publish Move Image",
...
public class MoveImageOrImagesetNightly implements WorkflowProcess {
