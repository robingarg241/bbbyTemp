...
@Component(
	    ...
	    immediate = true,
	    name = "File Upload FastTrack Servlet",
	    property = {
	        "sling.servlet.paths=/bin/bedbath/vendor-portal/upload-fasttrack",
	        "sling.servlet.extensions=json",
	        "sling.servlet.methods=GET,POST",
	        "sling.servlet.resourceTypes=cq:Page"
	    })
public class FileUploadFastTrackServlet extends SlingAllMethodsServlet {

    private static final long serialVersionUID = 2598426539166789515L;

    private final Logger log = LoggerFactory.getLogger(FileUploadFastTrackServlet.class);
